"""
CESC Mysore Bill Downloader - Standalone Script
Downloads electricity bills from CESC Mysore portal with custom credentials
...
class CESCMysoreBillDownloader:
    def __init__(self, username: str, password: str, download_folder: str = "bills", 
        ...
        """
        Initialize CESC Mysore Bill Downloader
        
        Args:
            username: CESC Mysore account username/consumer ID
            password: CESC Mysore account password
        ...
        self.login_url = "https://cescmysore.in/cesc/login"
        self.pdf_data = None
    ...
    def download_bills(self, headless=False, fetch_history=False, bill_month=None):
        """
        Download bills from CESC Mysore portal
...
def main():
    ...
    DOWNLOAD_FOLDER = "cescmysore_bills"  # Folder to save bills
    FETCH_HISTORY = True  # Set to True to download all available bills
    ...
    logger.info("Starting CESC Mysore Bill Downloader")
