"""
HESCOM Bill Downloader - Standalone Script
Downloads electricity bills from HESCOM portal with custom credentials
...
class HESCOMBillDownloader:
    def __init__(self, username: str, password: str, download_folder: str = "bills", 
        ...
        """
        Initialize HESCOM Bill Downloader
        
        Args:
            username: HESCOM account username/consumer ID
            password: HESCOM account password
        ...
        self.login_url = "https://www.hescom.co.in/hescom/login"
        self.pdf_data = None
    ...
    def download_bills(self, headless=False, fetch_history=False, bill_month=None):
        """
        Download bills from HESCOM portal
...
def main():
    ...
    DOWNLOAD_FOLDER = "hescom_bills"  # Folder to save bills
    ...
    logger.info("Starting HESCOM Bill Downloader")
